...
server.listen(PORT, '127.0.0.1', async () => {
  const tmpDir = path.join(ARTIFACT_DIR, 'scratch', 'chrome-bottom');
  ...
  fs.writeFileSync(path.join(ARTIFACT_DIR, 'exact_bottom_footer.png'), Buffer.from(shot.data, 'base64'));
  console.log('Saved exact_bottom_footer.png');
